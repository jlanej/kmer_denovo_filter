...
| `--kraken2-max-rss-gb` | – | Optional RSS cap for the Kraken2 subprocess. Heartbeats log current/peak RSS and Kraken2 is terminated if observed RSS exceeds this cap |
| **VCF mode** | | |
